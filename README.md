...
Variables are in `.env` — Supabase keys are already filled in. Twilio, n8n, and Anthropic keys are set when their phases are configured.
...
| 5 | Inbound SMS | Claude API auto-reply | Pending |
